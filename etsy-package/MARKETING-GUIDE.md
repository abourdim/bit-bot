...
| `output/en/screenshots/screenshot-sensors-annotated.png` | Chat panel with "Live from micro:bit" call-out. |
...
| `graph-record.gif` | Chat panel with Simulate running — live waveform | Etsy listing slot (secondary) · YouTube community post |
...
| `classroom-poster.html` | A3 poster for classroom wall. "We Chat with AI Robot Friends" + 5 steps. |
...
**Where:** Paste into `bit-bot/index.html` or the hosted live-demo
page (`abourdim.github.io/bit-bot`). Nothing else to do.
...
Output: `output/shared/buyers/BitBot-AS-12345-v1.2.0.zip`
...
**Where:**
- Own GitHub repo like `github.com/abourdim/bit-bot-companion`
- Listed in the Etsy description: "MakeCode extension published — search bit-bot-companion"
...
| URL | What buyer sees |
|---|---|
| `#tab=graph` | Chat panel, ready to Simulate |
| `#main` | Product demo screen |
| `#tab=senses&lang=fr` | Chat panel in French |

**Where:**
- Etsy description: "→ See the live 3D tab: abourdim.github.io/bit-bot/#tab=board3d"
