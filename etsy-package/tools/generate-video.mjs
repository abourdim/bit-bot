/**
 * Talking Robot video SCENES (adjust per session)
 * After apply-template.mjs substitutes Talking Robot / Chat • Listen • Learn • Play, verify
...
const SCENES = [
  { id: 1, dur: 3,  type: 'title',  text: 'Talking Robot',                   subtitle: 'Chat • Listen • Learn • Play' },
  { id: 2, dur: 7,  type: 'image',  src: 'screenshot-robot.png', effect: 'zoom-in' },
  { id: 3, dur: 10, type: 'image',  src: 'screenshot-chat.png',       effect: 'pan-right' },
  { id: 4, dur: 10, type: 'image',  src: 'screenshot-settings.png',   effect: 'zoom-in' },
  { id: 5, dur: 10, type: 'image',  src: 'screenshot-robot.png',    effect: 'pan-left' },
  { id: 6, dur: 10, type: 'image',  src: 'screenshot-chat.png',  effect: 'zoom-out' },
  { id: 7, dur: 5,  type: 'cta',    text: 'Full kit',                           subtitle: '' },
  { id: 8, dur: 5,  type: 'end',    text: 'Talking Robot',                   subtitle: '' },
];
...
function sceneImage(s, out) {
  ...
  if (!existsSync(src)) {
    // Back-compat fallback to legacy filename (e.g. screenshot-chat.png).
