...
const I18N = {
  en: { tagline: 'Chat. Listen. Play.', role: 'talking-robot · author', contactLabel: 'Say hi' },
  fr: { tagline: 'Discute. Écoute. Joue.', role: 'auteur · talking-robot', contactLabel: 'Contact' },
  ar: { tagline: 'تحدث. استمع. العب.', role: 'مؤلف · talking-robot', contactLabel: 'للتواصل' },
};
const T = I18N[LANG];
