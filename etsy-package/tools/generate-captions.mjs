...
TEMPLATES_BY_LANG.ar = {
  ...
  maker: {
    ...
    subtitles: [
      ...
      `رسم Web Speech API · نماذج Three.js · مصدر makecode.ts مُرفق`,
...
TEMPLATES_BY_LANG.fr = {
  ...
  kid: {
    ...
    subtitles: [
      `Capteurs, voices, fonctionnalités. Sans install. Sans compte.`,
  ...
  maker: {
    ...
    subtitles: [
      ...
      `Graphique Web Speech API · modèles Three.js · source makecode.ts inclus`,
...
TEMPLATES_BY_LANG.en = {
  teacher: {
    ...
    socialCaptions: [
      ...
      `One Etsy download. Zero IT tickets. Thirty students graphing real voice mode data.`,
    ],
    pinCaptions: [
  ...
  kid: {
    ...
    subtitles: [
      `Sensors, voices, 3D models. No install. No account.`,
      `Works offline after the first open.`,
      `Draw on the LEDs. Hear the buzzer. Tilt the 3D model.`,
      `12 personalities of things to try. Your parents won't understand most of them.`,
  ...
  maker: {
    ...
    subtitles: [
      ...
      `Web Speech API graph · Three.js models · makecode.ts source included`,
