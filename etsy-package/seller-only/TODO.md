...
> 🧪 **Live demo**: <https://abourdim.github.io/bit-bot/>
...
- [ ] **Create the LAUNCH10 Etsy promo code** (Shop Manager → Marketing
      → Sales & coupons → new code `LAUNCH10`, $9 discount off $14.99,
...
- [ ] **Shoot a real micro:bit photo** for the hero. Current hero
      ...
      Chat panel. Good light, plain background, crop square.
...
- [ ] Final sanity check: does the description's "what you get" list
      exactly match what `TalkingRobot-v2.0.0.zip` actually contains?
...
- [x] ~~Host a live demo on GitHub Pages~~ — done. Live at
      <https://abourdim.github.io/bit-bot/>. Already in the
      listing description.
...
- [ ] **Create the LAUNCH10 promo code** (first 10 buyers: $14.99 → $9
