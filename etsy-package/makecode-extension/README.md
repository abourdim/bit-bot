...
[bit-bot browser app](https://abourdim.github.io/bit-bot/) —
...
2. **Advanced → Extensions → search** `abourdim/bit-bot-companion`
...
That's it. Sensor stream starts, LEDs / voices / buzzer all respond.
...
declares it, `main.ts` is the example, `bit-bot.ts` is the block
