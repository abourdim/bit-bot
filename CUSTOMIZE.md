# Customization checklist — Talking Robot
...
- [ ] `etsy-package/tools/generate-video.mjs` — ffmpeg-based generator
   ...
   `Talking Robot` / `Chat • Listen • Learn • Play` substitutions don't fit your design.
...
- [ ] (Optional) `gh api -X POST "repos/abourdim/bit-bot/pages" -f 'source[branch]=main' -f 'source[path]=/'` — enable GitHub Pages so the live demo URL in the listing actually works
